...
var OAuth2Strategy = require('passport-oauth2')
  , util = require('util')
  , uri = require('url')
  , GooglePeopleProfile = require('./profile/googlepeople')
...
function Strategy(options, verify) {
  ...
  this.name = 'google';
  this._userProfileURL = 'https://people.googleapis.com/v1/people/me?personFields=names,emailAddresses,photos';
  this._userProfileFormat = 'google-people';
}
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(this._userProfileURL, accessToken, function (err, body, res) {
    ...
    var profile = GooglePeopleProfile.parse(json);
