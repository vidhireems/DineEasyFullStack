...
describe('Test GET all Restaurants result from cloud host', function () {
    ...
    it('Should return an array object of all restaurants with more than 1 object from cloud', function (){
	...
	it('The elements in the array have the miniumum expected properties from cloud', function(){
